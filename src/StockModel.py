...
class StockModel(nn.Module):
    def __init__(self, feature_size, embed_size, embedding_dims = 8, hidden_layers = [64, 32], dropout=0.2, output_size=3):
        ...
        self.sequential_layers.append(nn.Linear(next_size, hidden_layers[0]))
        self.sequential_layers.append(nn.BatchNorm1d(hidden_layers[0]))
        self.sequential_layers.append(nn.LeakyReLU())#skip dropout for first layer
        next_size = hidden_layers[0]
        ...
        # for hidden_size in hidden_layers:
            ...
            self.sequential_layers.append(nn.LeakyReLU()) 
